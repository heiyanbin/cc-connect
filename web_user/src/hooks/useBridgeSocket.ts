...
export function useBridgeSocket({ bridgeCfg, platformName = 'web-user', sessionKey, projectName, onMessage }: UseBridgeSocketOptions) {
    ...
    const connect = () => {
      ...
      ws.onopen = () => {
        ...
        ws.send(JSON.stringify({
          ...
          metadata: { version: '1.0.0', description: 'Web User Frontend' },
        }));
      };
